...
## 7. Changing the homepage background photo

The top of the homepage shows a soft, blurred lifestyle photo behind the
headline. To use your own:

1. Save a photo as `images/hero.jpg` (landscape orientation works best —
   it gets blurred slightly and darkened, so it doesn't need to be
   perfect).
2. That's it — the homepage picks it up automatically.

If `images/hero.jpg` doesn't exist yet, the site shows a warm gradient
...
## 10. Deploying to Vercel (making it a live website)
