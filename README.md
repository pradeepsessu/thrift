...
├── products.js       → YOUR PRODUCTS — this is the file you edit
...
5. Refresh `index.html` in your browser. Your new product appears in the
   ...
   new brand, waist, or size you use will automatically show up in the
...
```html
<a href="#home" class="logo" data-nav-link>
  <span class="logo__mark">SECOND CUT</span>
  <span class="logo__sub">PANTS ONLY</span>
</a>
```
...
Change `"secondcut"` to your real Instagram username (no `@`, no spaces),
and change the email to your real address. This single edit updates the
"Buy on Instagram" button on every product **and** the Contact page —
you don't need to change it anywhere else.
...
1. Create a free account at [github.com](https://github.com) if you
   don't have one.
2. Click **New repository**. Give it a name, like `second-cut-site`.
...
3. Choose the GitHub repository you just created (`second-cut-site`).
...
5. After about 30 seconds, Vercel gives you a live link, something like
   `second-cut-site.vercel.app`. That's your website, live on the
   internet.
